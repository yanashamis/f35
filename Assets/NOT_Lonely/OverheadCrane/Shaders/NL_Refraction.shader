...
Shader "NOT_Lonely/NL_Refraction"
{
	Properties
	{
		...
		[ASEEnd]_RefractionDistanceFalloff("Refraction Distance Falloff", Range( 0 , 5)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _RefractionDistanceFalloff;
						...
						)
			{
				...
				float3 unpack9 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), _BumpScale );
				unpack9.z = lerp( 1, unpack9.z, saturate(_BumpScale) );
				float3 tex2DNode9 = unpack9;
				...
				float cameraDepthFade3 = (( eyeDepth -_ProjectionParams.y - _RefractionDistance ) / _RefractionDistanceFalloff);
				float4 fetchOpaqueVal15 = ASEHDSampleSceneColor(( (ase_grabScreenPosNorm).xy + (( ( _RefractionIntensity * saturate( ( 1.0 - cameraDepthFade3 ) ) ) * tex2DNode9 )).xy ), 0, GetInverseCurrentExposureMultiplier());
				
				surfaceDescription.Albedo = ( _Color * tex2D( _MainTex, uv_MainTex ) ).rgb;
				surfaceDescription.Normal = tex2DNode9;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = tex2DNode19.r;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = fetchOpaqueVal15.rgb;
...
/*ASEBEGIN
Version=18800
224;98;1495;925;1320.367;541.3661;1.40896;True;False
...
WireConnection;20;4;19;1
WireConnection;20;6;15;0
WireConnection;20;7;19;4
WireConnection;20;8;19;2
ASEEND*/
//CHKSM=C62D1B6F07B3AA8BA05BF92EC7F12A83B2F08BF6