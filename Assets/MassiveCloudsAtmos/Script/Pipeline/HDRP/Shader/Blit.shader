Shader "Hidden/MassiveCloudsAtmos/HDRP/Blit"
{
    HLSLINCLUDE
        ...
        #pragma shader_feature MC_MSAA_ENABLED
        #include "Packages/com.unity.render-pipelines.core/ShaderLibrary/Common.hlsl"
        #include "Packages/com.unity.render-pipelines.high-definition/Runtime/ShaderLibrary/ShaderVariables.hlsl"

        #ifdef MC_MSAA_ENABLED
        TEXTURE2D_X_MSAA(float4, _BlitTexture);
        #else
        TEXTURE2D_X(_BlitTexture);
        #endif
        TEXTURE2D(_MCFullScreenBlitSourceTexture);
        ...
        #ifdef MC_MSAA_ENABLED
            return LOAD_TEXTURE2D_X_MSAA(_BlitTexture, input.positionCS.xy, 0);
        #else
        ...
        float4 FragSingleTexture(Varyings input) : SV_Target
        {
            UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(input);
            return LOAD_TEXTURE2D(_MCFullScreenBlitSourceTexture, input.positionCS.xy);
        }
    ENDHLSL
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            HLSLPROGRAM
                #pragma vertex Vert
                #pragma fragment FragSingleTexture
            ENDHLSL
        }
